...
# Create SNS test topic and SQS test queue
...
awslocal sns subscribe --topic-arn "$sns_arn_prefix:$topic_name" \
 --protocol sqs --notification-endpoint "$sqs_arn_prefix:$queue_name"
